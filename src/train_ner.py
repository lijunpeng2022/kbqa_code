...
max_seq_len = 20
config_path = '../model/chinese_bert_wwm_L-12_H-768_A-12/publish/bert_config.json'
checkpoint_path = '../model/chinese_bert_wwm_L-12_H-768_A-12/publish/bert_model.ckpt'
...
model = load_model('../model/ner_model.h5', custom_objects=get_custom_objects())
